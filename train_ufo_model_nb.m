% Train UFO Prediction Model (Naive Bayes)
% This script loads the optimized data, generates synthetic negative samples,
% trains a Naive Bayes model, and saves it to 'dataset/ufo_model_nb.mat'.
...
model = fitcnb(X, y, ...
    ...
    'ResponseName', 'IsUFO', ...
    'DistributionNames', 'kernel'); % Use kernel distribution for flexibility

% Save Model and Shape Map
disp('Saving model to dataset/ufo_model_nb.mat...');
save('dataset/ufo_model_nb.mat', 'model', 'shapes');
